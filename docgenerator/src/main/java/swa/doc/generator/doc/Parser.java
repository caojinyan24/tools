...
import swa.doc.generator.common.ToolException;
...
public class Parser {
    ...
    InterfaceZ parseInterfaceInfo() throws Exception {
        ...
        interfaceZ.setClazz(Class.forName("swa.doc.generator.doc.test." + className));
